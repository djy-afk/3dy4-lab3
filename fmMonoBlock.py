...
if __name__ == "__main__":
	...
	state_if_lpf_16k = np.zeros(rf_taps - 1)
	...
	while (block_count + 1) * block_size < len(iq_data):
		...
		if_filt, state_if_lpf_16k = signal.lfilter(audio_coeff, 1.0, fm_demod,zi=state_if_lpf_16k)

		audio_block = if_filt[::audio_decim]
		...
		if block_count >= 10 and block_count < 12:
			...
			fmPlotPSD(ax1, if_filt, (rf_Fs / rf_decim) / 1e3, subfig_height[1], 'Extracted Mono')
